...
;;;###autoload
(defun sea/delete-trailing-newlines ()
...
;;;###autoload
(defun sea/set-indent-width (width)
...
;;;###autoload
(defun sea-disable-delete-trailing-whitespace-h ()
...
;;;###autoload
(defun sea-enable-show-trailing-whitespace-h ()
  "Enable `show-trailing-whitespace' in the current buffer."
  (setq-local show-trailing-whitespace t))

;;;###autoload
(defun sea-disable-show-trailing-whitespace-h ()
