...
# To extract glyphs from a font to svgs, use the following command (for example):
# fontforge -lang=ff -c 'Open($1); SelectWorthOutputting(); foreach Export("%u.svg"); endloop;' ../SymbolsNerdFont-Regular.ttf
